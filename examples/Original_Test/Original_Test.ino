 ...
 * @LastEditTime: 2024-12-28 11:40:11
 * @License: GPL 3.0
 */
...
bool GPS_Initialization_Successful_Flag = true;
...
{
    if (GPS_Initialization_Successful_Flag == true)
    {
...
void Original_Test_7()
{
    ...
    GPS_Initialization_Successful_Flag = true;

    CycleTime = millis() + 3000; // 超时判断

    while (Serial2.available() <= 0)
    {
        if (millis() > CycleTime)
        {
            GPS_Initialization_Successful_Flag = false;
